...
class AddSuper extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.post(characterSupers(params), {input, name, startup_frames, meter_used, recovery_on_hit, recovery_on_block, recovery_on_whiff, cancellable, blockstun, immune_to })
        .then((result) => {
