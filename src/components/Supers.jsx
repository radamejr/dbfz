            ...
            return(
               <div key={index}>
                  ...
                  { superMove.picture.url ? 
                    ...
                    {this.props.user && this.props.user.admin ? <button className="btn btn-primary btn-sm float-right" onClick={ (event) => this.editButtonClicked(index)}>Edit Super</button> : null} 
               </div>
