...
const specialVariants = (character_id, special_id, variant_id="") => {
  return `http://localhost:3030/api/v1/characters/${character_id}/specials/${special_id}/special_variants/${variant_id}`;
}
...
const superVariants = (character_id, super_id, variant_id="") => {
  return `http://localhost:3030/api/v1/characters/${character_id}/supers/${super_id}/super_variants/${variant_id}`;
}
